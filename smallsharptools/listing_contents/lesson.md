Now that you know where you are, take a look around at the contents of your home directory by using the `ls` command, which lists the contents of the directory:
